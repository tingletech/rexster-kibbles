!https://github.com/tinkerpop/rexster-kibbles/raw/master/rexster-frames/doc/images/rexster-frames-logo.png!
...
| @@Property@ "getters" of _frame_ | @http://base/graph/edges/1/tp/frames/{frame}@ | maps edge 1 to the specified _frame_ |
...
would find the vertex with an identifier of "1", wrap the returned vertex in a @Person@ frame, and utilize the @@Property@ "Frames annotations":https://github.com/tinkerpop/frames/wiki/Annotations to "get" a Person object as JSON.

Please note that the Frames Extension is very *experimental* at the moment.
